...
export default class RecipeDetails extends Component {
    ...
    //     this.state = {
    //         recipe: recipe,
    //         url: `https://www.food2fork.com/api/get?key=e45f47fb186996fc431f6a64c5ff1985&rId=${this.props.id}`
    //     }
    // }
    ...
    async componentDidMount() {
        ...
        const url = `https://www.food2fork.com/api/get?key=e45f47fb186996fc431f6a64c5ff1985&rId=${id}`;
        try {
                                ...
                                <h2 className="mt-3 mb-4">Ingredients</h2>
                                {
                                    ingredients.map((item, index) => {
                                        return (
                                            <li
                                                key={index}
                                                className="list-group-item text-slanted">{item}</li>
                                        )
                                    })
                                }
                            </ul>
